...
class Explanation4 extends StatefulWidget {
  ...
  @override
  State<Explanation4> createState() => _Explanation4State();
}

class _Explanation4State extends State<Explanation4> {
            ...
            bodyWidget: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Image.asset('assets/soal4e.jpg'),
                  const Text(
                      "Dari tabel di atas dapat dilihat bahwa saat t = 5 detik, kecepatan benda A sebesar 4 m/s sedangkan kecepatan benda B sebesar 6.5 m/s.")
                ],
              ),
            ),
          ),
            ...
            bodyWidget: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Center(child: Image.asset('assets/soal4g.png')),
                  Center(child: Image.asset('assets/soal4h.png')),
                  const Text(
                    """Dari persamaan posisi dapat ditentukan persamaan kecepatannya yaitu:""",
                    textAlign: TextAlign.justify,
                  ),
                  Center(child: Image.asset('assets/soal4i.png')),
                  const Text(
                    """Sehingga kecepatan benda A pada detik ke 5 adalah:""",
                    textAlign: TextAlign.justify,
                  ),
                  Center(child: Image.asset('assets/soal4j.png')),
                  const Text(
                    """Persamaan posisi benda B dapat dicari menggunakan persamaan garis lurus melalui dua buah titik:""",
                    textAlign: TextAlign.justify,
                  ),
                  Center(child: Image.asset('assets/soal4k.png')),
                  const Text(
                    """Dari persamaan posisi dapat ditentukan persamaan kecepatannya yaitu:""",
                    textAlign: TextAlign.justify,
                  ),
                  Center(child: Image.asset('assets/soal4l.png')),
                ],
              ),
            ),
          ),
